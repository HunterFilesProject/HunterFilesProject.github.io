/*
  ...
  ID SCHEME NOTE: Volume 1 documents use ids formatted "HF1#NNNN"
  (HF + volume number + # + a 4-digit number), e.g. "HF1#0001". The
  ...
  field value itself keeps the real "#" — that part is safe because
  the site only ever reads/writes it through URLSearchParams.
*/
